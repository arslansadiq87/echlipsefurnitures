...
class VariationManager(models.Manager):
    ...
    def headboards(self):
        return super(VariationManager, self).filter(variation_category='headboard', is_active=True)

    def mattresses(self):
        return super(VariationManager, self).filter(variation_category='mattress', is_active=True)
